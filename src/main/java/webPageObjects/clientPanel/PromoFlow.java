...
public class PromoFlow   {
	...
	private By checkBoxNotMaxReqAge = By.xpath("(//span[@class='check-box']//span[contains(text(),'Not maximum required')])[1]");
	private By checkBoxNotMaxReqEng = By.xpath("(//span[@class='check-box']//span[contains(text(),'Not maximum required')])[2]");
  ...
  // private By clickIntercom = By.xpath("//div[@class='intercom-1ior5cu e1a94o2o0']");
	...
	//private By contentEg = By.xpath("(//div[@class='sortable-container']//div//div)[1]");
	...
	public void iframe() throws InterruptedException {
		...
		action.moveToElement(driver.findElement(By.xpath("//div[@class='intercom-1ior5cu e1a94o2o0']"))).build().perform();
    ...
    /* public void saveAsDraft() throws InterruptedException {
    	...
    	// wait.until(ExpectedConditions.presenceOfElementLocated(draftToast));
    	 String toastmsg= wait.until(ExpectedConditions.visibilityOf((WebElement) draftToast)).getText();
    	 //String toastmsg = driver.findElement(draftToast).getText();
