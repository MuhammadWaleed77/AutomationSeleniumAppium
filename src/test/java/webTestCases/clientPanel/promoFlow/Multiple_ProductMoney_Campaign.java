...
public class Multiple_ProductMoney_Campaign extends BaseSel {
	...
	@Test
	public void multi_ProdMoney_Camp() throws InterruptedException {
		...
		pf.initialStepsPFlow("MultiProdMoney");
